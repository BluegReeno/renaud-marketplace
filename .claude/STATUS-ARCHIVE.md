# STATUS ARCHIVE — renaud-marketplace

Sessions up to and including 2026-08-29, moved verbatim out of `STATUS.md` on 2026-08-30.

Kept for the decisions, the deployment post-mortems and the runtime measurements it carries,
none of which are derivable from the code or from git history. Mixed French and English, left as
written — retranslating it would risk altering a figure or the shape of a trade-off. Not loaded
at session start.
